...
const getPhotos = ({id, url, likes, comments}) => `<a href="#" class="picture js-picture" data-id="${id}">
...
const createThumbnails = () => {
  photos.forEach((photo) => {
    picturesContainer.insertAdjacentHTML('beforeend', getPhotos(photo));
  });
};
...
export { initThumbnails, clearPhotos };
